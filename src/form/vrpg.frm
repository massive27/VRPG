...
#If HYDEBUG = 1 Then 'm''
dbmsg ("Form1 Show change color and menu") 'm''
#End If 'm''
...
Private Sub menu_mod_cheat_Click(Index As Integer)
...
'm'' unlimited skill level
    If menu_mod_cheat(0).Checked = False Then 'm''
        menu_mod_cheat(0).Checked = True 'm''
    ...
    Else 'm''
        menu_mod_cheat(0).Checked = False 'm''
    End If 'm''
Case 1 'm''
'm'' set char point
...
Case 2 'm''
'm'' do not digest
    If menu_mod_cheat(2).Checked = False Then
        menu_mod_cheat(2).Checked = True
    Else
        menu_mod_cheat(2).Checked = False
    End If
...
Case 5 'm''
'm'' Cheats and others features of debugging
