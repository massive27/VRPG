...
sprt2.TransparentDraw cStage.hDC, sprt2.X, sprt2.Y, sprt2.cell, False
...
If drawing = 1 Then Stop: Exit Function
drawing = 1
...
Sub rangecolor(ByVal r, ByVal g, ByVal bl, pc As PictureBox, Optional ByVal lightness As Single = 0.5)
